  ...
  // const classes = Styles();
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await fetch('http://154.26.130.251:302/Invoice/GetAllHeader?OrganizationId=1');
            ...
            <div className="content">
                <div className="col-lg-12">
                  <Grid container justifyContent='space-between' sx={{padding:'15px 0'}}>
                    <Grid item>
                    <Typography variant="h1" sx={{ fontSize: { xs: '0.8rem', sm: '1.2rem', md: '1.2rem' } , fontWeight:'bold' }}>INVOICE</Typography>
                    </Grid>
                    <Grid item>
                        <Grid container>
                            <Grid item>
                            ...
                            <Grid item>
                                ...
                                <Button variant="contained" size="medium" sx={{margin:'0 0 0 10px'}} ><Link sx={{color:'white'}} to="/dream-pos/application/create_invoice" >Add New <AddIcon /></Link></Button>
                            </Grid>
                            <Grid item>
                  ...
                  <Grid container sx={{border:'1px solid grey' , padding:'10px'}}>
                    <Grid container justifyContent='space-between' spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={3} lg={2}>
                            <Button variant="contained" size="medium" fullWidth>Search</Button>
                        </Grid>
                    </Grid>
                    <Grid container sx={{margin:'10px 0'}}>
                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            ...
                            <TableRow sx={{background:'#ff9f43'}}>
                                ...
                                <TableCell sx={{fontWeight:'bolder'}}>View</TableCell>
                                <TableCell sx={{fontWeight:'bolder'}}>Invoice No</TableCell>
                                ...
                                <TableCell sx={{fontWeight:'bolder'}}>Net Total</TableCell>
                                <TableCell sx={{fontWeight:'bolder'}}>Balance</TableCell>
                            ...
                            {(rowsPerPage > 0
                                ...
                                <TableCell sx={{ padding: '0px 16px', ...cellStyle(index) }}>< DownloadIcon /></TableCell>
                                ...
                                <TableCell sx={{ padding: '0px 16px', ...cellStyle(index) }}>{row.CustomerId}</TableCell>
                                <TableCell sx={{ padding: '0px 16px', ...cellStyle(index) }}>{row.CustomerName}</TableCell>
                                <TableCell sx={{ padding: '0px 16px', ...cellStyle(index) }}>{row.NetTotal}</TableCell>
                                <TableCell sx={{ padding: '0px 16px', ...cellStyle(index) }}>{row.BalanceAmount}</TableCell>
                                <TableCell sx={{ padding: '0px 16px', ...cellStyle(index) }}>
